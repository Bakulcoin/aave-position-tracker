    ...
    <div className="space-y-6">
      ...
      <div className="card p-6">
        ...
        <div className="grid grid-cols-2 gap-4 mb-6">
          <div>
            <p className="text-sm text-gray-400 mb-1">Initial Net Worth</p>
            <p className="text-xl font-bold">${data.summary.initialNetWorth.toFixed(2)}</p>
          </div>
          <div>
            <p className="text-sm text-gray-400 mb-1">Current Net Worth</p>
            <p className="text-xl font-bold">${data.summary.currentNetWorth.toFixed(2)}</p>
          </div>
        </div>
            ...
            <div>
              <p
                className={`text-3xl font-bold ${
                  data.summary.totalPnL >= 0 ? 'text-green-500' : 'text-red-500'
                }`}
              >
              ...
              >
                {data.summary.totalPnL >= 0 ? '+' : ''}
                {data.summary.pnlPercentage.toFixed(2)}%
              </p>
            </div>
          </div>
        </div>
